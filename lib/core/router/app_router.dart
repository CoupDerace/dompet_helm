...
import 'package:dompet_helm/presentation/pages/payment/payment_deeplink_page.dart';
...
import '../../presentation/pages/auth/twofa_totp_pages.dart';
import '../../presentation/pages/auth/verify_email.pages.dart';
...
class AppRouter {
  ...
  static GoRouter get router => GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/setup-2fa', builder: (_, __) => const Setup2FAPage()),
      GoRoute(
        path: '/2fa/smtp',
        builder: (_, state) {
